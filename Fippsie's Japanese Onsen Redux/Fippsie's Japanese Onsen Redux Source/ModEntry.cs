...
internal sealed class ModEntry : Mod
{
    ...
    private static BuildingData CreateBigOnsenData()
    {
        BuildingData data = new()
        {
            Name = "Onsen",
            Description = "Hot Springs for your farm",
...
XXXXOOOXXXXXXXXXXXXXXXXXX",
    ...
    private static BuildingData CreateSmallOnsenData()
    {
        BuildingData data = new()
        {
            Name = "SmallOnsen",
            Description = "Small Hot Springs for your farm",
