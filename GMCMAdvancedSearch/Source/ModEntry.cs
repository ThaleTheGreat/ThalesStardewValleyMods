...
public sealed class ModEntry : Mod
{
    ...
    private void OnButtonPressed(object? sender, ButtonPressedEventArgs e)
    {
        ...
        {
            // Suppress the close input before closing so Stardew doesn't also
            // receive the same Escape press and open the inventory/game menu.
        ...
        // Keep typed search text from triggering gameplay/mod hotkeys, while
        // leaving mouse input available for clicking results and scrolling.
