...
namespace ThaleTheGreat.MoonMisadventures.Game.Projectiles
{
    [XmlType( "Mods_ThaleTheGreat_MoonMisadventures_AsteroidProjectile" )]
    public class AsteroidProjectile : Projectile
    {
        ...
        :   this()
        {
            ...
            isMagnetic.Value = ( index.Value / ( isBig.Value ? 3 : 5 ) ) == 1;
