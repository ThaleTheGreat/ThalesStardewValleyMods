...
namespace ThaleTheGreat.MoonMisadventures.Game.Locations.DungeonLevelGenerators
{
    public abstract class BaseDungeonLevelGenerator
    {
        ...
        protected void PlacePreviousWarp( AsteroidsDungeon location, int centerX, int groundY )
        {
            ...
            global::ThaleTheGreat.MoonMisadventures.MapTileHelper.SetMapTile( location,  centerX + -1, groundY - 2, 503, "Front", null, ts );
            global::ThaleTheGreat.MoonMisadventures.MapTileHelper.SetMapTile( location,  centerX +  0, groundY - 2, 504, "Front", null, ts );
            global::ThaleTheGreat.MoonMisadventures.MapTileHelper.SetMapTile( location,  centerX +  1, groundY - 2, 505, "Front", null, ts );
            global::ThaleTheGreat.MoonMisadventures.MapTileHelper.SetMapTile( location,  centerX + -1, groundY - 1, 532, "Front", null, ts );
            global::ThaleTheGreat.MoonMisadventures.MapTileHelper.SetMapTile( location,  centerX +  0, groundY - 1, 533, "Front", null, ts );
            global::ThaleTheGreat.MoonMisadventures.MapTileHelper.SetMapTile( location,  centerX +  1, groundY - 1, 534, "Front", null, ts );
            global::ThaleTheGreat.MoonMisadventures.MapTileHelper.SetMapTile( location,  centerX + -1, groundY - 0, 561, "Buildings", "AsteroidsWarpPrevious", ts );
            global::ThaleTheGreat.MoonMisadventures.MapTileHelper.SetMapTile( location,  centerX +  0, groundY - 0, 562, "Buildings", "AsteroidsWarpPrevious", ts );
            global::ThaleTheGreat.MoonMisadventures.MapTileHelper.SetMapTile( location,  centerX +  1, groundY - 0, 563, "Buildings", "AsteroidsWarpPrevious", ts );
        }
        ...
        protected void PlaceNextWarp( AsteroidsDungeon location, int centerX, int groundY )
        {
            ...
            global::ThaleTheGreat.MoonMisadventures.MapTileHelper.SetMapTile( location,  centerX + -1, groundY - 2, 503+9, "Front", null, ts );
            global::ThaleTheGreat.MoonMisadventures.MapTileHelper.SetMapTile( location,  centerX + 0, groundY - 2, 504+9, "Front", null, ts );
            global::ThaleTheGreat.MoonMisadventures.MapTileHelper.SetMapTile( location,  centerX + 1, groundY - 2, 505+9, "Front", null, ts );
            global::ThaleTheGreat.MoonMisadventures.MapTileHelper.SetMapTile( location,  centerX + -1, groundY - 1, 532+9, "Front", null, ts );
            global::ThaleTheGreat.MoonMisadventures.MapTileHelper.SetMapTile( location,  centerX + 0, groundY - 1, 533+9, "Front", null, ts );
            global::ThaleTheGreat.MoonMisadventures.MapTileHelper.SetMapTile( location,  centerX + 1, groundY - 1, 534+9, "Front", null, ts );
            global::ThaleTheGreat.MoonMisadventures.MapTileHelper.SetMapTile( location,  centerX + -1, groundY - 0, 561+9, "Buildings", "AsteroidsWarpNext", ts );
            global::ThaleTheGreat.MoonMisadventures.MapTileHelper.SetMapTile( location,  centerX + 0, groundY - 0, 562+9, "Buildings", "AsteroidsWarpNext", ts );
            global::ThaleTheGreat.MoonMisadventures.MapTileHelper.SetMapTile( location,  centerX + 1, groundY - 0, 563+9, "Buildings", "AsteroidsWarpNext", ts );
        }
        ...
        protected void PlaceTeleporter( AsteroidsDungeon location, Random rand, int num, bool active, int centerX, int groundY, int targetX, int targetY )
        {
            ...
            if ( !active )
            {
                global::ThaleTheGreat.MoonMisadventures.MapTileHelper.SetMapTile( location,  centerX, groundY - 2, offset + 0 + 8, "Front", null, ts );
                global::ThaleTheGreat.MoonMisadventures.MapTileHelper.SetMapTile( location,  centerX, groundY - 1, offset + 9 + 8, "Front", null, ts );
                global::ThaleTheGreat.MoonMisadventures.MapTileHelper.SetMapTile( location,  centerX, groundY - 0, offset + 18 + 8, "Buildings", "LunarTeleporterOffline " + location.teleports.Count, ts );
            }
            else
            {
                ...
                global::ThaleTheGreat.MoonMisadventures.MapTileHelper.SetMapTile( location,  centerX, groundY - 2, 8, "Paths", null, ts2 );
                location.setAnimatedMapTile( centerX, groundY - 2, a, 300, "Front", "z_moon-teleporters", null, false );
                location.setAnimatedMapTile( centerX, groundY - 1, b, 300, "Front", "z_moon-teleporters", null, false );
                location.setAnimatedMapTile( centerX, groundY, c, 300, "Buildings", "z_moon-teleporters", "LunarTeleporter " + location.teleports.Count, false );
            }
                    ...
                    case 6:
                        ...
                        switch ( rand.Next( 5 ) )
                        {
                            ...
                            case 2:
                                break;
                            case 3:
                                item.holding.Value = new FarmAnimal("Lunar Cow", multiplayer.getNewID(), 0);
                                break;
                            case 4:
                                item.holding.Value = new FarmAnimal("Lunar Chicken", multiplayer.getNewID(), 0);
                                break;
                        }
                        chest.addItem( item );
                        break;
