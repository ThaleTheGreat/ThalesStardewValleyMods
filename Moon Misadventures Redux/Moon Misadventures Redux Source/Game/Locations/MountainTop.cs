...
{
    [XmlType( "Mods_ThaleTheGreat_MoonMisadventures_MountainTop" )]
                ...
                switch ( qa )
                {
                    case "RepairUfo_Yes":
                             ...
                             Game1.player.Items.CountId( "(O)896" /* galaxy soul */ ) >= 1 )
                        {
                            ...
                            multiplayer.globalChatInfoMessage( "RepairedUfo", Game1.player.Name );
                    ...
                    case "TravelUfo_Yes":
                        ...
                        if ( !Game1.player.hasOrWillReceiveMail( "ThaleTheGreat.MoonMisadventures_FirstUfoTravel" ) )
                        {
                            Game1.addMailForTomorrow( "ThaleTheGreat.MoonMisadventures_FirstUfoTravel", noLetter: true );
