...
{
    [XmlType( "Mods_ThaleTheGreat_MoonMisadventures_UfoInterior" )]
    public class UfoInterior : GameLocation
    {
        ...
        public override bool performAction(string[] action, Farmer who, Location tileLocation)
        {
            if (action[0] == "MoonArtifact")
            {
                ...
                {
                    "(O)ThaleTheGreat.MoonMisadventures_MoonArtifact0",
                    "(O)ThaleTheGreat.MoonMisadventures_MoonArtifact1",
                    "(O)ThaleTheGreat.MoonMisadventures_MoonArtifact2",
                    "(O)ThaleTheGreat.MoonMisadventures_MoonArtifact3",
                    "(O)ThaleTheGreat.MoonMisadventures_MoonArtifact4",
                    "(O)ThaleTheGreat.MoonMisadventures_MoonArtifact5"
                });
