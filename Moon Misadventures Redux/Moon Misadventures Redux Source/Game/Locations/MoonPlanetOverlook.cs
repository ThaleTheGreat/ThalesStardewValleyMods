...
{
    [XmlType( "Mods_ThaleTheGreat_MoonMisadventures_MoonPlanetOverlook" )]
    public class MoonPlanetOverlook : LunarLocation
    {
        ...
        private static string PickCombatNecklace()
        {
            ...
            foreach (var choice in Game1.content.Load<Dictionary<string, NecklaceData>>("ThaleTheGreat.MoonMisadventures/Necklaces"))
            {
