...
{
    [XmlType("Mods_ThaleTheGreat_MoonMisadventures_Necklace")]
    public class Necklace : Item
    {
        ...
        {
            var data = Game1.content.Load<Dictionary<string, NecklaceData>>("ThaleTheGreat.MoonMisadventures/Necklaces");
