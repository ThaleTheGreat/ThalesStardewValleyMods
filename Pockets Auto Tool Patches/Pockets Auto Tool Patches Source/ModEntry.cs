...
public sealed class ModEntry : Mod
{
    ...
    private void PatchAutomateToolSwap()
    {
        ...
        if (setTool is null || setItem is null || harmony is null)
        {
    ...
    private void PatchToolSmartSwitch()
    {
        ...
        if (switchToolType is null || harmony is null)
        {
    ...
    private void PatchAutoToolSelect()
    {
        ...
        if (autoToolSelect is null || harmony is null)
        {
        ...
        harmony.Patch(setTool, prefix: new HarmonyMethod(typeof(ModEntry), nameof(AutoToolSelectSetToolPrefix)));
        harmony.Patch(setItem, prefix: new HarmonyMethod(typeof(ModEntry), nameof(AutoToolSelectSetItemPrefix)));
        harmony.Patch(setScythe, prefix: new HarmonyMethod(typeof(ModEntry), nameof(AutoToolSelectSetScythePrefix)));
        harmony.Patch(setWeapon, prefix: new HarmonyMethod(typeof(ModEntry), nameof(AutoToolSelectSetWeaponPrefix)));
