...
public sealed class ModEntry : Mod
{
    ...
    private void OnUpdateTicked(object sender, UpdateTickedEventArgs e)
    {
        ...
        Game1.activeClickableMenu = new WaitSelectMenu(this.AdvanceTime);
    }
    ...
    private void SnapAllNpcsToScheduleNow(bool stabilizeAfterTeleport)
    {
        try
        {
            ...
            foreach (NPC npc in this.GetAllNpcsSnapshot())
            {
                ...
                {
                    // Preserve the original behavior: a bad custom schedule shouldn't stop the rest.
                }
            ...
            this.Monitor.Log($"WaitMenu: snapped NPCs to schedule for {Game1.timeOfDay}. NPCs moved: {moved}.", LogLevel.Trace);
        }
        catch (Exception ex)
        {
